...
const createProduct = async (products) => {
  const { name, description, photo, price, quantity, inStock, categoryName, tagNames = [] } = products;
...
const products = [
  ...
  // short description and long one + *disclaimer
  {
    ...
    description:
      'A delicious and nutritious meal replacement shake designed to support a calorie-controlled diet. Packed with essential vitamins, minerals, high-quality protein, and fiber to help you feel satisfied and energized throughout your day.',
    price: 95,
    quantity: 0,
    inStock: true,
  ...
  },
  {
    name: 'Night Mode',
    description:
      'Enjoy a relaxing evening with Night Mode, a food supplement infused with scientifically studied saffron extract, created for your night-time routine. Night Mode is expertly formulated with a blend of carefully selected vitamins to help support normal psychological function and the maintenance of the normal function of the nervous system. Immerse yourself in a moment of mindfulness with Night Mode. Savour the warm subtle flavours of chamomile and peach as you wind down for the evening. Vitamin B6 and Vitamins B6 and Riboflavin.',
    price: 114,
    quantity: 0,
    inStock: true,
  ...
  },
  {
    ...
    description:
      'Microbiotic Max is a powdered supplement with live bacteria and fibre to support your nutrition goals. It contains 2 billion live bacteria from Bifidobacterium lactis and Lactobacillus helveticus strains, and is high in fibre.',
    price: 96,
    quantity: 0,
    inStock: true,
  ...
  },
  {
    ...
    description:
      'Specially formulated to meet the daily nutritional needs of women, this expert-developed supplement delivers 24 essential micronutrients to support overall wellbeing. Key nutrients such as Vitamin B6 contribute to hormonal balance, Vitamin B12 supports energy metabolism, and Zinc helps maintain healthy bones, skin, hair, and nails — all in one convenient daily tablet.',
    price: 54,
    quantity: 0,
    inStock: true,
  ...
  },
  {
    ...
    description:
      'Plant-powered protein to complement your shake or enjoy on its own. A clean, vegan-friendly source of protein designed to satisfy hunger and support energy throughout the day.',
    price: 109,
    quantity: 0,
    inStock: true,
  ...
  },
  {
    ...
    description:
      'Boost your daily protein intake with 15g of high-quality soy protein per serving. Enjoy it alone or add it to your Formula 1 shake to reach 24g of protein, helping you stay full and energized.',
    price: 114,
    quantity: 0,
    inStock: true,
  ...
  },
  {
    ...
    description:
      'A revitalizing herbal tea with 87.5mg of caffeine per serving to boost alertness and focus. Ideal for mornings or an afternoon pick-me-up — low in calories and bursting with flavor.',
    price: 118,
    quantity: 0,
    inStock: true,
