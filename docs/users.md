...
**Access:** Admin _apiFetch service function sends header with access token._
...
**Access:** Private or Admin _apiFetch service function sends header with access token._
...
**Access:** Public _apiFetch service function sends header with access token._
